...
class UserServices{
  ...
  static Future<String>uploadSignedDocument(File file)async{
    final ref=_storage.ref("signedDocuments/${file.hashCode}");
 ...
 static Future<void> deleteSignedDocument(String userId,String url) async {

    await _usersCollection.doc(userId).update({
      'signedDocuments': FieldValue.arrayRemove([url]),
    });
  }

  static Future<void> addUser(SeekerModel model,String userId,BuildContext context)async{
