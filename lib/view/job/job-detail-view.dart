      ...
      body: SafeArea(child: SymmetricPadding(child: SingleChildScrollView(
        child: Column(
          ...
          children: [
            ...
            const Divider(),
            5.height,
            MyText(text: '''• Tergeo damnatio terminatio adeo tergum bos bis.
        •  Optio auditor sui nisi.
        •  Aestivus amplexus tonsor architecto cerno defetiscor.
        •  Maiores approbo error adnuo unde video sursum 
           sint comes.''',size: 14.sp,fontWeight: FontWeight.w400,
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        ...
        2.height,
        MyText(text: "Click Confirm if you wanna apply",fontFamily: AppFonts.poppins,size: 12.sp,fontWeight: FontWeight.w500,color: Color(0xff949494),),
        10.height,
        ...
        Row(
          ...
          children: [
            ...
            RoundButton(
                width: 140.w,
                title: "Confirm", onTap: (){
                  Navigator.pushNamed(context, RoutesNames.applyJobView);
